                ...
                <div className={styles.row}>
                    ...
                    <div className={`${styles.entryContent} col-md-7 col-xs-7 has-thumb`}>
                        <h1 className={`${styles.entryTitle} entry-title p-name`} itemprop="name headline">
                            <a href={`/novosti/iz-svijeta-filma/film/${novost.id}`} rel="bookmark" className="u-url url" itemprop="url">
                                {novost.title}
                            </a>
                        </h1>
                        <div className={styles.entryInfo}>
                            ...
                            <span>/</span>
                            <a className="url u-url" href={`/novosti/iz-svijeta-filma/film/${novost.id}`}>
