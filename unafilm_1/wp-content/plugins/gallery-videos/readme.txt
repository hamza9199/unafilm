...
* Animations for the appearance of the gallery - These are the effects so that when the gallery opens, the videos appear with beautiful effects. You will still have a beautiful gallery. These animations work in pagination and in Load-more. We have 10 effects. All effects are very beautiful in different ways.
...
* [Effect 3 - Demo](https://total-soft.com/wp-video-gallery-parallax-2/)
* [Effect 4 - Demo](https://total-soft.com/wp-video-gallery-content-popup-2/)
* [Effect 5 - Demo](https://total-soft.com/wp-video-gallery-elastic-2/)
* [Effect 6 - Demo](https://total-soft.com/wp-video-gallery-space/)
* [Effect 7 - Demo](https://total-soft.com/wp-video-gallery-thumbnails-2/)
* [Effect 8 - Demo](https://total-soft.com/wp-video-gallery-effective/)
* [Effect 9 - Demo](https://total-soft.com/wp-video-gallery-classic-2/)
* [Effect 10 - Demo](https://total-soft.com/wp-video-gallery-thumbnails/)
...
**Pagination** - It will be shown for so long how many you marke for every page. Will be divided by pages. These animations work in pagination and in Load-more. We have 10 effects.
...
1. An example of plugin in action - All Galleries Theme
2. An example of plugin in action - All Pagination Type
3. An example of plugin in action - All Load More Type
...
* Fixed a bug in the Admin Panel. Copy and search did not work.
...
* Added a new effect for opening the gallery.
* Added function "Only text, Only Icon, Text with icon".
* Fixed a bug in the gallery grid. The response on the phone did not work correctly.

= Version 2.2.6 =

* Fixed problem with pagination. Gallery did not work correctly in the grid.

= Version 2.2.5 =

* Video bug fixed. More than 80 videos were not added to the galleries.
* Fixed a bug with mp4 video. There was no sound in the popup.

= Version 2.2.4 =

* The problem with video description has been resolved.

= Version 2.2.2 =

* All bugs with PHP8 have been fixed.

= Version 2.2.0 =

* Fixed a bug on all gallery types. The problem was with YouTube and Vimeo videos.

= Version 2.1.9 =

* Fixed bug related to YouTube video.

= Version 2.1.8 =

* Fixed a bug with description. In the grid version the description did not work correctly.

= Version 2.1.7 =

* Fixed a bug with the image. Video from YouTube made black stripes.
* Fixed a bug when adding videos from YouTube.

= Version 2.1.6 =

* The problem with Content popup has been resolved. texts entered during “edit” video are not retain.
...
* Added the ability to change popup icons.
* Problem solved. In the gallery when the pop-up opened. Description didn't work.

= Version 2.0.1 =

* Problem solved. The lightbox in the Elastic Gallery theme did not open.

= Version 2.0.0 =

* Resolved issue in Thumbnails theme. Popup didn't work.

= Version 1.9.9 =

* The problem with copying the gallery has been resolved.

= Version 1.9.8 =

* Added the ability to change the size of the lightbox.
* Problem fixed. When the popup opened up with her, another popup opened up.
* Problem fixed. Functions did not beat the problem with the update. The problem was with the Avada theme.

= Version 1.9.7 =

* I n the Content popup theme, the title has not changed in the lightbox. Problem solved.

= Version 1.9.6 =

* Added new feature for Youtube and Vimeo.

= Version 1.9.5 =

* Added new feature for video. You can choose video "YouTube, Vimeo and MP4" autoplay or not.

= Version 1.9.4 =

* Fixed issue with shortcode. 2 galleries didn't work on the same page.

= Version 1.9.3 =

* Added function for Elementor. You can add a video gallery through the shortcode and through the widget.

= Version 1.9.2 =

* Added function for pagination. 2 animation for changing the gallery page.
* Fixed a bug on the popup on the video grid theme.

= Version 1.9.1 =

* Pagination doesn't work in Gutenberg. Problem solved.

= Version 1.9.0 =

* Added feature in admin panel. See on the phone and tablet how it will show.
* Solved the problem with the video "Youtube and Vimeo".

= Version 1.8.9 =

* Added the ability to see on desktop, tablet and mobile how the gallery will show.
* Changed responsive for video. YouTube and Vimeo.

= Version 1.8.8 =

* Added function for YouTube video viewing.

= Version 1.8.7 =

* Added a new popup effect in Grid Theme
* Fixed bug in popup on topics "Grid, Thumbnails gallery and Content popup"

= Version 1.8.6 =

* Fixed a bug with popup. The video didn't open correctly.

= Version 1.8.5 =

* Added function for pagination.
* Added function for adding image.
* Fixed bug with mp4 video format.

= Version 1.8.3 =

* Added a new link for YouTube.

= Version 1.8.2 =

* Fixed a bug with Vimeo.

= Version 1.8.1 =

* Youtube video bug fixed. New videos have not been added to the plugin.

= Version 1.8.0 =

* Added 7 types of pagination to galleries.
* Added to the gallery 5 types of load more.
* Added the ability to add multiple galleries to the site.
* Added a function to open the gallery effect. There are 10 very beautiful effects.

= Version 1.7.7 =

* Bug fixed: Two of the same gallery type on the same lightbox page didn't work.
* Added pagination and load more types.
* Added function for pagination.
* Fixed a bug with the Grid Gallery theme. The lightbox in the mobile version did not work correctly.
* Fixed an issue with the Gallery Content theme. The lightbox in the mobile version did not work correctly.
* Video issue resolved in all galleries. YouTube video didn't work.

= Version 1.7.6 =

* Fixed a small bug.
* Tested up to version 6.1.

= Version 1.7.5 =

* Tested version of PHP.

= Version 1.7.4 =

* Fixed bug with Lightbox.

= Version 1.7.3 =

* Changed popup size in Grid Gallery type.

* Problem fixed. After editing the video has not changed.
