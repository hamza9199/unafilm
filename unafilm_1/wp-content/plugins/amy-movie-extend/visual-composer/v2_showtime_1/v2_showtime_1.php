...
if (!function_exists('amy_v2_movie_showtime_1')) {
	function amy_v2_movie_showtime_1($atts, $content = '', $key = '') {
	...
	add_shortcode('amy_v2_movie_showtime_1', 'amy_v2_movie_showtime_1');
}