...
$params[] =	array(
	...
	'options' 		=> array(
		'daily-2' 		=> AMY_MOVIE_PLUGIN_URL . '/assets/image/shortcode/v2/showtime_layout_4.png',
	),
	'std'			=> 'daily-2',
...
vc_map(array(
	'name' 				=> esc_html__('V2 - Showtime 4', 'amy-movie-extend'),
	'base' 				=> 'amy_v2_movie_showtime_4',
	'icon'				=> 'fa fa-calendar',
	'is_container'   	=> true,
