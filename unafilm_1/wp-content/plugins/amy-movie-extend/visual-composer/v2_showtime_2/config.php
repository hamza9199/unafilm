...
$params[] =	array(
	...
	'heading' 		=> esc_html__('Layout Weekly', 'amy-movie-extend'),
	'param_name' 	=> 'layout_weekly',
	'options' 		=> array(
		'2' 		=> AMY_MOVIE_PLUGIN_URL . '/assets/image/shortcode/v2/showtime_layout_2.png',
	),
	'std'			=> '2',
...
vc_map(array(
	'name' 				=> esc_html__('V2 - Showtime 2', 'amy-movie-extend'),
	'base' 				=> 'amy_v2_movie_showtime_2',
	'icon'				=> 'fa fa-calendar',
	'is_container'   	=> true,
