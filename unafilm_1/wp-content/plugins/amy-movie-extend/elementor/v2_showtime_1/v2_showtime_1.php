...
class Amy_Widget_Amy_V2_Movie_Showtime_1 extends \Elementor\Widget_Base {
	public function get_name() {
		return 'Amy_V2_Movie_Showtime_1';
	}

	public function get_title() {
		return esc_html__('V2 - Showtime 1', 'amy-movie-extend');
	}

	public function get_icon() {
		return 'eicon-date amy-widget';
	}
	...
	protected function add_layout_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'     => '1',
				'options'     => array(
					'1' => esc_html__('Layout 1', 'amy-movie-extend'),
				),
			]
		);
	...
	protected function render() {
		...
		$movie_showtime_1_query = new WP_Query($arpg);

        ob_start();

        set_query_var('class', $class);
        set_query_var('movie_showtime_1_query', $movie_showtime_1_query);
        ...
        $template->get_template_part('/shortcode/v2-showtime-1');
...
\Elementor\Plugin::instance()->widgets_manager->register(new \Amy_Widget_Amy_V2_Movie_Showtime_1());