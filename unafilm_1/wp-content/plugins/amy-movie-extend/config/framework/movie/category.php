...
CSF::createSection(AMY_MOVIE_OPTION, [
    'title'     => esc_html__('Category', 'amy-movie-extend'),
    'icon'      => 'fas fa-tag',
    'parent'    => 'movie',
    'fields'    => [
        array(
            'id'		=> 'movie_genre_heading',
            'type'		=> 'heading',
            'content'	=> esc_html__('Genre & Category Page', 'amy-movie-extend'),
        ),
        ...
        array(
            ...
            'dependency'		=> array('genre_sidebar', 'any', 'right,left'),
            'default'			=> 'right-bar',
        ),

        array(
            'id'			=> 'movie_genre_orderby',
            'type'			=> 'select',
            'class'			=> 'chosen',
        ...
        array(
            ...
            'default'		=> 'layout1',
            'dependency'	=> array('genre_layout', '==', 'grid'),
        ),
        ...
        array(
            ...
            'default'		=> 'grid-1',
            'dependency'	=> array('genre_layout', '==', 'grid-2'),
        ),
        ...
        array(
            ...
            'default'			=> '4',
            'dependency'	=> array('genre_layout|grid_layout', '==|any', 'grid|layout1,layout3,layout4'),
        ),
        ...
        array(
            ...
            'default'			=> '2',
            'dependency'	=> array('genre_layout|grid_layout', '==|==', 'grid|layout2'),
        ),
        ...
        array(
            ...
            'default'			=> '4',
            'dependency'	=> array('genre_layout|grid_v2_layout', '==|==', 'grid-2|grid-1'),
        ),
        ...
        array(
            ...
            'default'			=> '2',
            'dependency'	=> array('genre_layout|grid_v2_layout', '==|==', 'grid-2|grid-2'),
        ),
